...
const categories: CertificateCategory[] = [
  {
    ...
    items: [
      { title: "Write Professional Emails in English", institution: "Coursera", date: "2026" },
      { title: "Verbal Communications and Presentation Skills", institution: "Coursera", date: "2026" },
      { title: "Active Listening: Enhancing Communication Skills", institution: "Coursera", date: "2026", assetHint: "Active Listening Enhancing Communication" },
      { title: "Developing Interpersonal Skills", institution: "Coursera", date: "2026" },
      { title: "Work Smarter, Not Harder: Time Management for Personal & Professional Productivity", institution: "Coursera", date: "2026" },
      { title: "Emotional Intelligence in the Workplace", institution: "Coursera", date: "2026" },
      { title: "Finding Your Professional Voice: Confidence & Impact", institution: "Coursera", date: "2026" },
      { title: "Introduction to Personal Branding", institution: "Coursera", date: "2026" },
      { title: "Leading with Impact: Team Dynamics, Strategy and Ethics", institution: "Coursera", date: "2026" },
      { title: "Financial Planning for Young Adults", institution: "Coursera", date: "2026" },
      { title: "Preparation for Job Interview", institution: "Coursera", date: "2026", assetHint: "Preparation for Job Interviews" },
      { title: "Job Interview Preparation Mastery", institution: "Coursera", date: "2026" },
      { title: "Prepare and Practice for Interviews with AI", institution: "Coursera", date: "2026" },
      { title: "Psychology of the Self", institution: "Coursera", date: "2026" },
      { title: "Managing Conflicts with Cultural and Emotional Intelligence", institution: "Coursera", date: "2026" },
      { title: "Positive Psychology: Resilience Skills", institution: "Coursera", date: "2026" },
      { title: "Grit and Growth Mindset", institution: "Coursera", date: "2026" },
      { title: "Solving Problems with Creative and Critical Thinking", institution: "Coursera", date: "2026" },
      { title: "Negotiation Skills: Negotiate and Resolve Conflict", institution: "Coursera", date: "2026" },
    ],
  },
  {
    title: "AI Bootcamp",
    items: [
      { title: "Generative AI: Prompt Engineering Basics", institution: "Coursera", date: "2026", assetHint: "Generative AI Prompt Engineering Basics" },
      { title: "AI For Everyone", institution: "Coursera", date: "2026" },
      { title: "Introduction to Artificial Intelligence", institution: "Coursera", date: "2026", assetHint: "Introduction to AI" },
      { title: "Introduction to Generative AI", institution: "Coursera", date: "2026" },
      { title: "AI Essentials", institution: "Coursera", date: "2026", assetHint: "AI Essential" },
      { title: "Generative AI with Large Language Models", institution: "Coursera", date: "2026" },
      { title: "AI Foundations: Prompt Engineering with ChatGPT", institution: "Coursera", date: "2026", assetHint: "AI Foundations Prompt Engineering with ChatGPT" },
      { title: "Python for Data Science, AI and Development", institution: "Coursera", date: "2026" },
      { title: "Supervised Machine Learning: Regression and Classification", institution: "Coursera", date: "2026", assetHint: "Supervised Machine Learning Regression and Classification" },
      { title: "Advanced Learning Algorithms", institution: "Coursera", date: "2026" },
      { title: "Unsupervised Learning, Recommenders, Reinforcement Learning", institution: "Coursera", date: "2026" },
      { title: "Trustworthy AI: Managing Bias, Ethics and Accountability", institution: "Coursera", date: "2026" },
      { title: "Introduction to Responsible AI", institution: "Coursera", date: "2026" },
    ],
  },
  {
    title: "Google AI Essentials Specialization",
    items: [
      { title: "Introduction to AI", institution: "Google", date: "2026", assetHint: "Introduction to AI" },
      { title: "Maximize Productivity with AI Tools", institution: "Google", date: "2026" },
      { title: "Discover the Art of Prompting", institution: "Google", date: "2026" },
      { title: "Use AI Responsibly", institution: "Google", date: "2026" },
      { title: "Stay Ahead of the AI Curve", institution: "Google", date: "2026" },
      { title: "Google AI Essentials", institution: "Google", date: "2026" },
    ],
  },
  {
            ...
            <div className="flex items-center justify-between border-b border-border px-5 py-4 sm:px-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {[viewing?.institution, viewing?.date ? `Completed ${viewing.date}` : null]
                    .filter(Boolean)
                    .join(" • ")}
                </p>
              </div>
